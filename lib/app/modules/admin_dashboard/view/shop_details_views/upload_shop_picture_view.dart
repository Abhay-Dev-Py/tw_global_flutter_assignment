...
class UploadShopPictureView extends StatefulWidget {
  const UploadShopPictureView({Key? key}) : super(key: key);

  @override
  State<UploadShopPictureView> createState() => _UploadShopPictureViewState();
}

class _UploadShopPictureViewState extends State<UploadShopPictureView> {
  @override
